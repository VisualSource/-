...
func f(n, hue, light, sat int) int {
	k := (n + hue/30) % 12
...
It returns an array of three numbers representing the red, green, and blue channels of the colors,
...
*/
func HslToRgb(hue, sat, light int) (int, int, int) {
	hue = hue % 360
